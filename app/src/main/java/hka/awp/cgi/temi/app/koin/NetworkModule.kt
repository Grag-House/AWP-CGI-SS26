...
/**Koin Module for network requests**/
val weatherModule =
    module {
        single<OkHttpClient> {
            // This is needed, because the Temi root certs expired in 2021
            val rootCert = """
            -----BEGIN CERTIFICATE-----
            ...
            val certificates = HandshakeCertificates.Builder().addTrustedCertificate(rootCert.decodeCertificatePem())
